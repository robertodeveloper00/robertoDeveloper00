...
var pauseTag = document.querySelector('.about-video__tag--pause');
var playTag = document.querySelector('.about-video__tag--play'); // Functions
...
aboutVideo.addEventListener('mouseover', function () {
...
aboutVideo.addEventListener('mouseout', function () {
  resetHover();
});
